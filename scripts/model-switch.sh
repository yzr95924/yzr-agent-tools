#!/usr/bin/env bash
# Manage model-switch: install | uninstall
#
# Self-contained: writes the bin/model-switch wrapper, links bash/zsh/fish
...
#
# Usage:
#     scripts/model-switch.sh install      # wrapper + completions + PATH block
#     scripts/model-switch.sh uninstall    # remove all of the above
set -euo pipefail
